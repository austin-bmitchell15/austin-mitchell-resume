...
\education{
    \educationItem[
        ...
        graduation=May 2025,
        grade=4.0,
        program=Master of Science in Computer Science---Machine Learning Specialization,
        city=Atlanta,
        state=GA,
        coursework=Graduate Algorithms{,} Deep Learning{,} Machine Learning{,} Big Data Systems{,} Computer Vision
    ]
    \begin{bullets}
        \vspace{-1.5em}
        \itemsep-6pt {}
    ...
    \educationExtension[
        ...
        coursework=Data Structures and Algorithms{,} Enterprise Computing{,} Networks and Systems{,} Artificial Intelligence
    ]
    \begin{bullets}
        \vspace{-1.5em}
        \itemsep-6pt {}
...
\begin{workSection}{Work Experience}
    ...
    \begin{experience}{Georgia Tech Research Institute (GTRI)}{Atlanta{,} GA}{Graduate Research Assistant --- Clearance: Secret}{May 2024\textendash{May 2025}}
